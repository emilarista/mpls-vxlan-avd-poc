...
| Ethernet3 | P2P_LINK_TO_P-3B_Ethernet3 | routed | - | 100.64.48.21/31 | default | 9178 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P-4A_Ethernet6 | routed | - | 100.64.48.37/31 | default | 9178 | false | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_P-3B_Ethernet3
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_P-4A_Ethernet6
   no shutdown
   mtu 9178
   speed 100full
   no switchport
