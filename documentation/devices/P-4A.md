...
| Ethernet3 | P2P_LINK_TO_P-1B_Ethernet3 | routed | - | 100.64.48.11/31 | default | 9178 | false | - | - |
| Ethernet4 | P2P_LINK_TO_P-2B_Ethernet4 | routed | - | 100.64.48.35/31 | default | 9178 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P-4B_Ethernet6 | routed | - | 100.64.48.36/31 | default | 9178 | false | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_P-1B_Ethernet3
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_P-2B_Ethernet4
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_P-4B_Ethernet6
   no shutdown
   mtu 9178
   speed 100full
   no switchport
