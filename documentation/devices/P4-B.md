...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.16.32.208/24 | 172.16.32.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_PE-4B_Ethernet2 | routed | - | 100.64.48.40/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_P3-B_Ethernet3 | routed | - | 100.64.48.21/31 | default | 1500 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P4-A_Ethernet6 | routed | - | 100.64.48.39/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_PE-4B_Ethernet2
   no shutdown
   mtu 1500
   speed 100full
   no switchport
   ip address 100.64.48.40/31
   mpls ip
   isis enable CORE
...
!
interface Ethernet3
   description P2P_LINK_TO_P3-B_Ethernet3
   no shutdown
   mtu 1500
   speed 100full
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_P4-A_Ethernet6
   no shutdown
   mtu 1500
   speed 100full
   no switchport
   ip address 100.64.48.39/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | LSR_Router_ID | default | 100.70.3.38/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.70.3.38/32
   isis enable CORE
   isis passive
   node-segment ipv4 index 308
```
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0003.0008.00 |
| Type | level-2 |
| Address Family | ipv4 unicast |
| Router-ID | 100.70.3.38 |
...
!
router isis CORE
   net 49.0001.0000.0003.0008.00
   is-type level-2
   router-id ipv4 100.70.3.38
