...
| Ethernet3 | P2P_LINK_TO_P-2A_Ethernet3 | routed | - | 100.64.48.4/31 | default | 9178 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P-1B_Ethernet6 | routed | - | 100.64.48.2/31 | default | 9178 | false | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_P-2A_Ethernet3
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_P-1B_Ethernet6
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
| 100.70.2.2 | Inherited from peer group RR-OVERLAY-PEERS | default | - | Inherited from peer group RR-OVERLAY-PEERS | Inherited from peer group RR-OVERLAY-PEERS | - | Inherited from peer group RR-OVERLAY-PEERS | - |
