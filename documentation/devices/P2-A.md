...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.16.32.202/24 | 172.16.32.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_PE-2_Ethernet4 | routed | - | 100.64.48.28/31 | default | 9178 | false | - | - |
| Ethernet3 | P2P_LINK_TO_P1-A_Ethernet3 | routed | - | 100.64.48.5/31 | default | 9178 | false | - | - |
| Ethernet5 | P2P_LINK_TO_P2-GW_Ethernet1 | routed | - | 100.64.48.26/31 | default | 9178 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P2-B_Ethernet6 | routed | - | 100.64.48.30/31 | default | 9178 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_PE-2_Ethernet4
   no shutdown
   mtu 9178
   speed 100full
   no switchport
   ip address 100.64.48.28/31
   mpls ip
   isis enable CORE
...
!
interface Ethernet3
   description P2P_LINK_TO_P1-A_Ethernet3
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_P2-GW_Ethernet1
   no shutdown
   mtu 9178
   speed 100full
   no switchport
   ip address 100.64.48.26/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
!
interface Ethernet6
   description P2P_LINK_TO_P2-B_Ethernet6
   no shutdown
   mtu 9178
   speed 100full
   no switchport
   ip address 100.64.48.30/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| 100.70.1.14 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - |
| 100.70.1.15 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - |
| 100.70.1.16 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - |
| 100.70.2.1 | Inherited from peer group RR-OVERLAY-PEERS | default | - | Inherited from peer group RR-OVERLAY-PEERS | Inherited from peer group RR-OVERLAY-PEERS | - | Inherited from peer group RR-OVERLAY-PEERS | - |
...
router bgp 65000
   ...
   neighbor 100.70.2.1 peer group RR-OVERLAY-PEERS
