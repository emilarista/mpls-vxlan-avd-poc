...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.30.30.111/24 | 10.30.30.1 |
...
| Ethernet3 | P2P_LINK_TO_P-4B_Ethernet3 | routed | - | 100.64.48.20/31 | default | 9178 | false | - | - |
| Ethernet5 | P2P_LINK_TO_GW3_Ethernet1 | routed | - | 100.64.48.22/31 | default | 9178 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P-3A_Ethernet6 | routed | - | 100.64.48.15/31 | default | 9178 | false | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_P-4B_Ethernet3
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_P-3A_Ethernet6
   no shutdown
   mtu 9178
   speed 100full
   no switchport
