...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet4 | P2P_LINK_TO_P-2A_Ethernet2 | routed | - | 100.64.48.29/31 | default | 9178 | false | - | - |
| Ethernet5 | P2P_LINK_TO_P-2B_Ethernet2 | routed | - | 100.64.48.33/31 | default | 9178 | false | - | - |
...
!
interface Ethernet4
   description P2P_LINK_TO_P-2A_Ethernet2
   no shutdown
   mtu 9178
   speed 100full
   no switchport
   ip address 100.64.48.29/31
   mpls ip
   isis enable CORE
...
!
interface Ethernet5
   description P2P_LINK_TO_P-2B_Ethernet2
   no shutdown
   mtu 9178
   speed 100full
   no switchport
   ip address 100.64.48.33/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 100.70.1.13/32 |
