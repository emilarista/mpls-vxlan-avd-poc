...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SP2_Ethernet1 | routed | - | 100.64.22.1/31 | default | 9000 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_SP2_Ethernet1
   no shutdown
   mtu 9000
   no switchport
   ip address 100.64.22.1/31
...
| Net-ID | 49.0001.0000.0022.0001.00 |
| Type | level-2 |
