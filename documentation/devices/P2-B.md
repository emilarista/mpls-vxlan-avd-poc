...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.16.32.204/24 | 172.16.32.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_PE-2_Ethernet5 | routed | - | 100.64.48.32/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_P3-A_Ethernet3 | routed | - | 100.64.48.17/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_P4-A_Ethernet4 | routed | - | 100.64.48.34/31 | default | 1500 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P2-A_Ethernet6 | routed | - | 100.64.48.31/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_PE-2_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.48.32/31
   mpls ip
   isis enable CORE
...
!
interface Ethernet3
   description P2P_LINK_TO_P3-A_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_P4-A_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.48.34/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
!
interface Ethernet6
   description P2P_LINK_TO_P2-A_Ethernet6
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.48.31/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | LSR_Router_ID | default | 100.70.3.34/32 |
