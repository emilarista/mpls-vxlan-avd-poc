...
| Ethernet3 | P2P_LINK_TO_P-1A_Ethernet3 | routed | - | 100.64.48.5/31 | default | 9178 | false | - | - |
| Ethernet5 | P2P_LINK_TO_GW2_Ethernet1 | routed | - | 100.64.48.26/31 | default | 9178 | false | - | - |
| Ethernet6 | P2P_LINK_TO_P-2B_Ethernet6 | routed | - | 100.64.48.30/31 | default | 9178 | false | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_P-1A_Ethernet3
   no shutdown
   mtu 9178
   speed 100full
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_P-2B_Ethernet6
   no shutdown
   mtu 9178
   speed 100full
   no switchport
